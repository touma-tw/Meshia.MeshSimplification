...
{
    internal class AvatarMeshSimplifierToumaPreview : MeshSimplifierPreviewBase<AvatarMeshSimplifierToumaPreview>
    {
        public override ImmutableList<RenderGroup> GetTargetGroups(ComputeContext context)
        {
            ...
            foreach (var root in context.GetAvatarRoots())
            {
                ...
                foreach (var component in context.GetComponentsInChildren<AvatarMeshSimplifierTouma>(root, true))
                {
        ...
        {
            var data = group.GetData<(AvatarMeshSimplifierTouma, int)>();
            ...
            var preserveBorderEdgeBoneIndices = AvatarMeshSimplifierTouma.GetPreserveBorderEdgesBoneIndices(avatarRoot, component, cascadingTarget);
