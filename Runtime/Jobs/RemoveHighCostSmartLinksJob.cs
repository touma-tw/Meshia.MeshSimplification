        ...
        public void Execute(int subMeshIndex)
        {
            ...
            while (subMeshSmartLinkIndex < subMeshSmartLinkList.Length)
            {
                ...
                if (
                    ...
                    && (VertexTexCoord1Buffer.Length == 0 || SquaredDistance(VertexTexCoord1Buffer, link) < squaredMaxUvDistance)
                    && (VertexTexCoord2Buffer.Length == 0 || SquaredDistance(VertexTexCoord2Buffer, link) < squaredMaxUvDistance)
                    && (VertexTexCoord3Buffer.Length == 0 || SquaredDistance(VertexTexCoord3Buffer, link) < squaredMaxUvDistance)
                    && (VertexTexCoord4Buffer.Length == 0 || SquaredDistance(VertexTexCoord4Buffer, link) < squaredMaxUvDistance)
                    && (VertexTexCoord5Buffer.Length == 0 || SquaredDistance(VertexTexCoord5Buffer, link) < squaredMaxUvDistance)
                    && (VertexTexCoord6Buffer.Length == 0 || SquaredDistance(VertexTexCoord6Buffer, link) < squaredMaxUvDistance)
                    && (VertexTexCoord7Buffer.Length == 0 || SquaredDistance(VertexTexCoord7Buffer, link) < squaredMaxUvDistance)
                    )
                {
